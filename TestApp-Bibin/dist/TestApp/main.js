...
var FakeBackendInterceptor = /** @class */ (function () {
    ...
    FakeBackendInterceptor.prototype.intercept = function (request, next) {
        ...
        function register() {
            var user = body;
            if (users.find(function (x) { return x.mobileNo === user.mobileNo; })) {
        ...
        function authenticate() {
            var mobileNo = body.mobileNo, password = body.password;
            var user = users.find(function (x) { return x.mobileNo === mobileNo && x.password === password; });
            if (!user)
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (mobileNo, password) {
        var _this = this;
        return this.http.post('${config.apiUrl}/users/authenticate', { mobileNo: mobileNo, password: password })
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.survey = function (survey) {
...
module.exports = "<!-- nav -->\n\n\n<nav class=\"navbar-fixed-top navbar-default\" style=\"background-color:#3f98a7;color:#FFF;margin:0px;\" *ngIf=\"currentUser\">\n    <div class=\"container\">\n\n        <a class=\"navbar-brand nav-color\" href=\"#\">ABC Co</a>\n\n\n      <ul class=\"nav navbar-nav navbar-right\" style=\"padding-right:0px;text-align:right;\">\n        <li ><a href=\"#\" class=\"nav-color\" (click)=\"logout()\"><span class=\"glyphicon glyphicon-log-out\" style=\"color:azure;\"></span><span style=\"color:azure;\"> Logout</span></a></li>\n      </ul>\n    </div>\n  </nav>\n\n\n<!-- main app container -->\n<div class=\"container\">\n<div class=\"jumbotron\" style=\"background-color:white;\">\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-sm-6 offset-sm-3\">\n                <alert></alert>\n                <router-outlet></router-outlet>\n            </div>\n        </div>\n    </div>\n</div>\n</div>\n\n"
...
/* harmony import */ var _survey__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./survey */ "./src/app/survey/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _survey__WEBPACK_IMPORTED_MODULE_11__["SurveyComponent"]
            ],
            providers: [
...
/* harmony import */ var _survey__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./survey */ "./src/app/survey/index.ts");
...
var appRoutes = [
    ...
    { path: 'survey', component: _survey__WEBPACK_IMPORTED_MODULE_5__["SurveyComponent"] },
    { path: '**', redirectTo: '' }
];
...
module.exports = "\n<div class=\"container\">\n    <div class=\"row\" class=\"prod-header\">\n        <h3>Products</h3>\n    </div>\n    <div class=\"row\" style=\"padding-bottom:10px;\">\n      <div class=\"col-sm-12 text-center\" style=\"color: #3f98a7;\">\n      Click the images to start / View survey\n    </div>\n    </div>\n    <div class=\"row\">\n        <div class=\"col-sm-12 text-center\">\n            <img src=\"../../assets/1.png\" class=\"img-responsive img\" alt=\"Cinque Terre\" width=\"100%\" (click)=\"startSurvey('1');\">\n            <span class=\"ui-prod\">Aluminium Tin Foil</span>\n        </div>\n    </div>\n    <div class=\"row\" style=\"padding-top:20px;\">\n        <div class=\"col-sm-12 text-center\">\n            <img src=\"../../assets/2.jpg\" class=\"img-responsive img\" alt=\"Cinque Terre\" width=\"100%\" (click)=\"startSurvey('2');\">\n            <span class=\"ui-prod\">Key Chain</span>\n        </div>\n    </div>\n</div>\n\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.startSurvey = function (productId) {
        console.log('YES');
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.ngOnInit = function () {
        this.registerForm = this.formBuilder.group({
            ...
            mobileNo: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(10), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(10)],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _survey_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./survey.component */ "./src/app/survey/survey.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SurveyComponent", function() { return _survey_component__WEBPACK_IMPORTED_MODULE_0__["SurveyComponent"]; });
...
module.exports = "<p>\n  Product Survey\n</p>\n<form [formGroup]=\"surveyForm\" (ngSubmit)=\"onSubmit()\">\n    <input type=\"hidden\" formControlName=\"productId\" [(ngModel)]=\"productId\"/>\n    <div class=\"form-group\">\n        <label for=\"product\">How long did you know the product</label>\n        <input type=\"text\" formControlName=\"product\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.product.errors }\" />\n        <div *ngIf=\"submitted && f.product.errors\" class=\"invalid-feedback\">\n            <div *ngIf=\"f.product.errors.required\">Product is required</div>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label for=\"future\" >Intrested to purchase this product in future</label>\n        <div>\n            <input type=\"radio\" value=\"yes\" formControlName=\"future\" style=\"margin-right:10px;\" > Yes\n            <input type=\"radio\" value=\"no\" formControlName=\"future\" style=\"margin-right: 10px;\" > No\n            <div>\n            <span class=\"error-msg\" style=\"color:red;font-size: 80%;\" *ngIf=\"submitted && surveyForm.controls['future'].errors?.required\">Please select one option</span>\n            </div>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label for=\"feedback\">Feedback Comments:</label>\n        <textarea id=\"feedback\"  [disabled]='disableStatus'  class=\"md-textarea form-control\" rows=\"3\"   formControlName=\"feedback\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.feedback.errors }\"></textarea>\n        <div *ngIf=\"submitted && f.feedback.errors\" class=\"invalid-feedback\">\n            <div *ngIf=\"f.feedback.errors.required\">Feedback is required</div>\n            <div *ngIf=\"f.feedback.errors.minLength\">Minimum 10 characters required</div>\n        </div>\n    </div>\n\n    <div class=\"form-group\" [hidden] =\"disableStatus\">\n        <button [disabled]=\"loading\" class=\"btn btn-primary\" style=\"background-color:#3f98a7;border-color:#3f98a7;\">Submit Survey</button>\n        <img *ngIf=\"loading\" class=\"pl-3\" src=\"data:image/gif;base64,\" />\n    </div>\n</form>\n"
...
var SurveyComponent = /** @class */ (function () {
    function SurveyComponent(route, formBuilder, authenticationService, userService, alertService, router) {
        this.route = route;
        this.formBuilder = formBuilder;
        this.authenticationService = authenticationService;
        this.userService = userService;
    ...
    SurveyComponent.prototype.ngOnInit = function () {
        ...
        this.surveyForm = this.formBuilder.group({
            productId: [''],
            product: [{ value: this.survey != null ? this.survey.product : "", disabled: this.disableStatus }, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            future: [{ value: this.survey != null ? this.survey.future : "", disabled: this.disableStatus }, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            feedback: [{ value: this.survey != null ? this.survey.product : "", disabled: this.disableStatus }, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(10)]]
        });
    };
    Object.defineProperty(SurveyComponent.prototype, "f", {
        get: function () { return this.surveyForm.controls; },
        enumerable: true,
        configurable: true
    });
    ...
    SurveyComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({ template: __webpack_require__(/*! ./survey.component.html */ "./src/app/survey/survey.component.html") }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _services__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"],
...
module.exports = __webpack_require__(/*! C:\Users\Saju\Desktop\ProjectBibin\src\main.ts */"./src/main.ts");
